...
Generic Execution stats
  ...
  iterations: 33
  elapsed time: 1.2609808444976807
```
...
{typeof(Main.var"##WeaveSandBox#312".f), Float64}}(0.0,6.9180673541317e-310,6.9180673541317e-310), Dual{ForwardDiff.Tag{typeof(Main.var"##WeaveSandBox#312".f), Float64}}(0.0,6.9180673044382e-310,6.918
0673044382e-310)]))
```
